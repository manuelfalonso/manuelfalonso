...
{
    /// <summary>  
    /// ScriptableObject for enabling a specific shader keyword in materials.  
    /// </summary>  
    [CreateAssetMenu(fileName = "NewEnableKeyword", menuName = "Sombra Studios/VFX/Material/Enable Keyword")]
    public class MaterialEnableKeywordVFXSO : MaterialVFXSO<UnityEngine.Rendering.LocalKeyword>
    {
        ...
        /// <summary>  
        /// Executes the VFX action by enabling the specified shader keyword in the materials.  
        ...
        /// <summary>  
        /// Reverts the VFX action by disabling the original shader keywords in the materials.  
        /// </summary>  
        /// <param name="vFXController">The VFX controller managing the renderer and materials.</param>  
        public override void RevertVFX(BaseVFXController vFXController)
        {
            ...
            {
                Debug.LogWarning($"MaterialEnableKeywordVFXSO: No original keyword found for {key}");
            }
